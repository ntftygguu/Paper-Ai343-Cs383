...
# Original TensorFlow class order:
# cancer = 0
# normal = 1
#
# Fixed model uses:
...
# cancer = 1
#
# Therefore, we invert labels:
# old cancer 0 -> new cancer 1
# old normal 1 -> new normal 0
...
for images, labels in test_ds:
    ...
    # Since cancer = 1, probability > threshold means cancer
...
confusion_matrix_path = os.path.join(
    RESULTS_DIR,
    f"test_confusion_matrix_threshold_{THRESHOLD}.png"
)
...
metrics_chart_path = os.path.join(
    RESULTS_DIR,
    f"test_metrics_threshold_{THRESHOLD}.png"
)
